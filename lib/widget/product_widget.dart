...
class productwidget  extends StatelessWidget {
 ...
 const productwidget(this.title,this.id,this.imageUrl,this.price,this.description,this.status,{Key? key});
 ...
 Widget build(BuildContext context) {
  ...
  secondaryActions: <Widget>[
    IconSlideAction(
      ...
      icon: Icons.edit,
      onTap: ()=>{  Navigator.of(context).pushNamed(addproductscreen.routeName,arguments:{'id':id}),
