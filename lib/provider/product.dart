...
enum Status{favourite,homescreen
  ...
  List<product>filterproduct({Status?status}){
    ...
    Future<void> getData() async{
     ...
     exrtactedDta.forEach((id, data) { 
       _products.add(product(title:data['title'],id: id,imageUrl:data['imageUrl'],price:data['price'],description: data['description'],),);
     });
    }

    Future <void>addproduct(
      String title,id,imageUrl,price,description,
    ) async{
     ...
     void editproductscreen(
      String title,id,imageUrl,price,description,
    ){
      _products.add(product(title:title,id:title,imageUrl:imageUrl,price:price,description:description));
      notifyListeners();
    }
